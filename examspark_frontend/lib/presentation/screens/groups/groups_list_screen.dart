...
/// screen for that teacher/group.
///
/// Placeholder data only (see GroupsRepository) — no backend wired yet.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Groups', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
        actions: [
          TextButton.icon(
