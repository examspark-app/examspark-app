...
MAX_SEARCH_CALLS_TOTAL = 5   # ~150 Tavily credits (well under free 1000/month)
MAX_RESULTS_PER_QUERY = 5
MAX_AI_CALLS_TOTAL = 5       # ~150 Qwen3 calls
MAX_ROWS_TOTAL = 20         # ~800 metadata rows inserted this run
# -----------------------------------------------------------------------------------
