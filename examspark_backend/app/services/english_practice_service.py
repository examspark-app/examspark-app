        ...
        [
            {"role": "system", "content": system_text},
            {
                ...
                "content": (
                    ...
                    f"playful reaction to starting {target} today — invent a fresh one "
                    f"every time, in {native}'s own natural everyday voice), then fold "
                    ...
                    f"of your greeting, in {native} — do NOT make it sound like a form "
                    f"field. If you already know their name from the memory block, "
                    f"use it naturally once instead of asking again.\n\n"
                    f"Then ask them, in {native}, whether they want to start with basic "
                    f"speaking, grammar, or vocabulary in {target}.\n\n"
                    ...
                    f"word into {native} is NOT acceptable — it must sound like a real "
                    f"{native} speaker's own natural, casual, excited voice, with its "
