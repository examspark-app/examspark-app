...
async def _call_qwen3(chat_messages: list[dict], temperature: float, max_tokens: int) -> str:
    """Direct OpenRouter call for the qwen3 model. Raises AskAiError on any failure."""
    try:
