      ...
      child: Column(
        ...
        children: [
          ...
          _buildQualityOption(
            ...
            credits: CreditCosts.whisperNonTurboHour,
          ),
  ...
  void _toggleRecording() {
    ...
    if (!_isRecording) {
      ...
      Navigator.pushNamed(
        context,
        '/processing',
        arguments: {'lectureId': 'placeholder-lecture-id'},
      );
    }
  }
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text('Best for noisy rooms or unclear speech (${CreditCosts.whisperNonTurboHour} credits)'),
            ],
          ),
        ),
        actions: [
